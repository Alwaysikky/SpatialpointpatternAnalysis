library(ggplot2)
setwd("E:/paper_POI&cases/paper_revision/7delay")
data1= read.csv("1_7delay_A_CP_result.csv")
data2= read.csv("2_7delay_A_result.csv")
data3= read.csv("3_7delay_A_result.csv")
data4= read.csv("4_7delay_A_result.csv")
data5= read.csv("5_7delay_A_CP_result.csv")
data6= read.csv("6_7delay_A_CP_result.csv")
...
ggsave(file="7delay.jpeg", width=4, height=3, dpi=300)