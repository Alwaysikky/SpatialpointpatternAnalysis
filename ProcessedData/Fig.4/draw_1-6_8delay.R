library(ggplot2)
setwd("E:/paper_POI&cases/paper_revision/8delay")
data1= read.csv("1_8delay_A_CP_result.csv")
data2= read.csv("2_8delay_A_result.csv")
data3= read.csv("3_8delay_A_result.csv")
data4= read.csv("4_8delay_A_result.csv")
data5= read.csv("5_8delay_A_CP_result.csv")
data6= read.csv("6_8delay_A_CP_result.csv")
...
ggsave(file="8delay.jpeg", width=4, height=3, dpi=300)
